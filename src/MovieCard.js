...
export default function MovieCard({ img, titl, id, rating, duration, genres }) {
    ...
    active:scale-95">
        <h3 className="text-md px-2 py-2 font-bold truncate">{titl}</h3>
        <img className="h-84 w-full" src={img} alt={titl} key={id}></img>
